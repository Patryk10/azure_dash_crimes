...
@dash_app.callback(Output("barplot","figure"),
...
@dash_app.callback(Output("crimes_number","children"),
              Input("submit-button2","n_clicks"))
def crdasimes_number(n_clicks):
    result = len(df_temp)
    
    return result


@dash_app.callback(Output("crimes_share","children"),
              Input("submit-button2","n_clicks"))
...
@dash_app.callback(Output("table-short","children"),
              Input("submit-button2","n_clicks"))
...
@dash_app.callback(Output("map","SrcDoc"),
              Input("submit-button2","n_clicks"))
def map(n_clicks):
